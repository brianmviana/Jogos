...
void main_iniciar_elementos(){
    ...
    //NAVE
    tnave[0] = sfTexture_createFromFile("../imagens/nave_final.png", NULL);
    snave[0] = sfSprite_create();
    sfSprite_setTexture(snave[0],tnave[0],0);

    tnave[1] = sfTexture_createFromFile("../imagens/nave_final2.png", NULL);
    snave[1] = sfSprite_create();
    sfSprite_setTexture(snave[1],tnave[1],0);

    tnave[2] = sfTexture_createFromFile("../imagens/nave_final3.png", NULL);
